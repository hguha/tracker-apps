// The one interface all server access goes through, so swapping Supabase is reimplementing this.
...
export interface SyncBackend {
  ...
  // A real DELETE for the "erase my data" path only — sync must never hard-delete,
