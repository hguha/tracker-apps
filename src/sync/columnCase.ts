 ...
 * two names for the same field (the §4.12 discipline, applied to casing).
 */
 ...
 * These columns convert on the way in and out so both sides stay in their
 * native representation without leaking the other's.
 */
