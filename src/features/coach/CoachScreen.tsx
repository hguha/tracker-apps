...
export function CoachScreen({
  ...
  // The live coach needs a real server-backed session; offline local accounts get heuristics.
  ...
  async function ask(request: CoachRequest) {
    if (!summary) return
    // Encouragement is Home-only; the screen only issues critique/plan/ask.
    ...
    try {
      ...
      if (live) {
        try {
          ...
          // Fall through to the offline mock rather than leaving the user with nothing.
